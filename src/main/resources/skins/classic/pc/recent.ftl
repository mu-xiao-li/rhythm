                    ...
                    <div class="module">
                        <div class="module-header fn-clear">
                            <span class="fn-right ft-fade">
                                ...
                                /
                                <a pjax-title="长篇文章 - ${symphonyLabel}" class="<#if "long" == current || "/long" == current>ft-gray</#if>" href="${servePath}/recent/long"><svg class="fn-text-top"><use xlink:href="#book"></use></svg> 长篇</a>
