...
<@top "mofish">
<h2 class="ranking-title">摸鱼大闯关游戏排行</h2>
<div class="list top">
    <ul>
        ...
        <li>
            <div class="fn-flex">
                ...
                <div class="has-view fn-flex-1">
                    ...
                    <div class="cmts tooltipped tooltipped-w" aria-label="Stage ${user.point}">
                        Stage ${user.point}<br>
                        <span style="color: #888f91">${user.passTime?number?number_to_datetime}</span>
                    </div>
                </div>
            </div>
        </li>
